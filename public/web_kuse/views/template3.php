		...
		<div class="container" style="padding-top: 10px;">
			<div class="row">
				<div class="col-sm-8">
					<div class="row">
						<div class="col-sm-2">
							<img src="<?=base_url()?>images/fselogo3.png" style="height:100px; width: auto;">
						</div>
						<div class="col-sm-10" style="color:#27A8A2;padding-top:15px;">
							<div style="font-size:2.2em;">ภาควิชาวิศวกรรมโยธาและสิ่งแวดล้อม</div>
	  ...
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav nav-justified">
	      	<li class="active"><a href="<?=base_url()?>page_ce/">หน้าแรก</a></li>
					<li class="dropdown">
	          ...
	          <ul class="dropdown-menu">
	            <li><a href="<?=base_url()?>page_ce/content/27">บุคลากรสาขา</a></li>
							<li><a href="<?=base_url()?>page_ce/content/67">หลักสูตร</a></li>
							<li><a href="<?=base_url()?>page_ce/content/68">แผนการศึกษา</a></li>
	          </ul>
        	</li>
	          ...
	          <ul class="dropdown-menu">
							...
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>ระดับปริญญาตรี</b></li>
							...
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>ระดับบัณฑิตศึกษา</b></li>
							...
							<li role="separator" class="divider"></li>
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>โครงการพิเศษ</b></li>
	          ...
	          <ul class="dropdown-menu">
	            <li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>ระบบสารสนเทศ</b></li>
							...
							<li role="separator" class="divider"></li>
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>หน่วยงานที่เกี่ยวข้อง</b></li>
	          ...
	          <ul class="dropdown-menu">
	            <li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>สำหรับหน่วยงาน</b></li>
							...
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>การเรียน/การสอน/การสอบ</b></li>
							<li><a href="http://misreg.csc.ku.ac.th/fsespt/exam/exam_teacher/">ระบบตรวจสอบห้องสอบ</a></li>
							<li><a href="http://office.csc.ku.ac.th/student/index.php?option=com_content&view=article&id=114&Itemid=151">ตารางเรียน</a></li>
							<li><a href="http://office.csc.ku.ac.th/student/index.php?option=com_content&view=article&id=115&Itemid=152">ตารางสอบ</a></li>
							<li role="separator" class="divider"></li>
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>สำหรับผู้บริหาร</b></li>
							<li><a href="http://nisitmis.csc.ku.ac.th/emis/executive/">สารสนเทศสำหรับผู้บริหาร</a></li>
							<li role="separator" class="divider"></li>
							<li style="padding:3px 20px;font-size:1.2em;color:#27A8A2;"><b>สำหรับอาจารย์</b></li>
