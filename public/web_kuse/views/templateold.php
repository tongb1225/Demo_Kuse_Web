	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav nav-justified">
	          ...
	          <ul class="dropdown-menu">
	            ...
	            <li role="separator" class="divider"></li>
	            <li><a href="<?=base_url()?>page/content/37">ยุทธศาสตร์</a></li>
	          </ul>
        	</li>
			...
			<div class="row">
			            <div class="col-sm-4">
							...
							<li><a href="https://goo.gl/forms/gjckVODUPHvMSNJR2">แบบฟอร์มสมัครโครงการสหกิจศึกษา</a></li>
							...
							<li><a href="http://kuse.csc.ku.ac.th/~alumni/">ระบบบัณฑิตและศิษย์เก่า</a></li>
				...
				<div class="col-sm-4">
							...
							<li><a href="http://kuse.csc.ku.ac.th/midterm/New/">ระบบคำร้องนิสิตคณะวว</a></li>
			...
			<div class="row">
	          ...
	          <ul class="dropdown-menu">
	            <li><a href="<?=base_url()?>page/content/56">ฝ่ายบริหารและวางแผน</a></li>
							...
							<li><a href="<?=base_url()?>page/content/58">ฝ่ายกิจการนิสิต</a></li>
...
<li class="dropdown">
	          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ดาวน์โหลด<span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            						<li><a href="<?=base_url()?>page/content/63">สำหรับบุคลากร</a></li>
							<li><a href="<?=base_url()?>page/content/65">สำหรับนิสิต</a></li>


	          </ul>
        	</li>
<li><a href="http://kuse.csc.ku.ac.th/~alumni/">ศิษย์เก่า</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4">
				...
				<h4>แผนยุทธศาสตร์</h4>
				<ul class="footer">
					<li><a href="http://kuse.csc.ku.ac.th/page/content/37">แผนยุทธศาสตร์</a></li>
